...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    #
        for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
            ...
            if RANK in [-1, 0]:
                ...
                callbacks.run('on_fit_epoch_end', log_vals, lth_save_epoch, best_fitness, fi)
                ...
                if (not nosave) or (final_epoch and not evolve):  # if save
                    ...
                    del ckpt
                    callbacks.run('on_model_save', last, lth_save_epoch, final_epoch, best_fitness, fi)
    ...
    if RANK in [-1, 0]:
        ...
        callbacks.run('on_train_end', last, best, plots, lth_save_epoch)
