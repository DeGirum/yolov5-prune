...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    dgPruner.dump_sparsity_stat_mask_base(model, save_dir, -2)  # -2 for pretrained model
    ...
    #
        for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
            ...
            dgPruner.reset_growth() # reseting growth at the begining of each epoch
            #
            model.train()
        ...
        for f in last, best:
            if f.exists():
                ...
                if f is best:
                    ...
                    if is_coco:
                        callbacks.run('on_fit_epoch_end', list(mloss) + list(results) + lr, lth_epoch, best_fitness, fi)

        callbacks.run('on_train_end', last, best, plots, lth_epoch, results)
